"""Ironbook Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.ironbook.pro"
NAME = "Ironbook Pro"
PRICE = "9.99"
DESCRIPTION = "Charts, records, plate maths and programs."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; logging workouts, history, templates, "
    "the live session and the rest timer are free forever. Pro unlocks the Progress tab (estimated "
    "one-rep max charts), the Records tab, plate maths and the program library. To see the paywall: "
    "open the Progress or Records tab and tap See Ironbook Pro, or tap the plate maths card or "
    "Programs on the Train tab. Restore purchase is on the paywall and on the Ironbook Pro card at "
    "the bottom of the Train tab."
)
